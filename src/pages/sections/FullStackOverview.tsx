...
import {
    faCode, faLaptopCode, faServer, faDatabase, faLayerGroup
...
const FullStackOverview: React.FC = () => {
    ...
    return (
        <section className="py-16 md:py-24 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-950 dark:to-indigo-900 text-gray-800 dark:text-gray-200 overflow-hidden relative font-sans">
